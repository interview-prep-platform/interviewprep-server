...
create table history (history_id UUID not null, created timestamp not null, external_key UUID not null, user_answer varchar(2000), user_question varchar(2000), question_id UUID not null, user_id UUID not null, primary key (history_id))
create table question (question_id UUID not null, answer varchar(2000), created timestamp not null, external_key UUID not null, question varchar(2000) not null, source varchar(100), primary key (question_id))
